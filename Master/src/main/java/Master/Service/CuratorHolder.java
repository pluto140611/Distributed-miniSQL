...
/**
 * @author: LENOVO
 * @since: 2023/5/28  10:21
 * @description:
 */

public class CuratorHolder {private CuratorFramework client = null;
        ...
        if (client == null) {
            synchronized (this) {
                ...
                client = CuratorFrameworkFactory.builder()
                        ...
                        .connectionTimeoutMs(ZookeeperManager.ZK_CONNECTION_TIMEOUT)
                        .sessionTimeoutMs(ZookeeperManager.ZK_SESSION_TIMEOUT)
